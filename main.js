...
hero.on('ready', async() => {
var server = "565645687736369174"; // ايدي السررفر
var channel = "565657073204068372";//ايدي الروم
    setInterval(()=>{
...
hero.on('ready', async() => {
var server = "565645687736369172"; // ايدي السررفر
var channel = "565657073204068372";//ايدي الروم
    setInterval(()=>{
    hero.guilds.get(server).channels.get(channel).send('#daily <@417282734638235648>');
    },86400);
})
